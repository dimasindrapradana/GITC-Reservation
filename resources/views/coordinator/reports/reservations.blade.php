        ...
        <div class="card-body">
            ...
            >
                ...
                <div class="filter-actions">
                    ...
                    <a
                        href="{{ route('coordinator.reports.reservations.export', request()->query()) }}"
                    ...
                    @forelse($reservations as $reservation)
                        ...
                        @php
                            if ($reservation->room !== null) {
                                ...
                                $resourceTypeLabel = 'Media Training Room';
            ...
            @if($reservations->hasPages())
                ...
                <div class="pagination">
                    ...
                    @foreach($reservations->getUrlRange(
                        ...
                        min($reservations->lastPage(), $reservations->currentPage() + 2)
                    ) as $page => $url)
